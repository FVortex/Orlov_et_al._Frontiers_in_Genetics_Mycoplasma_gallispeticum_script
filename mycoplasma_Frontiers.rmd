...
Function for dynamical properties (according to the model of Ryasik et al., 2015) as well as sliding window GC-content calculation
...
```{r Reading in sequences of vlhA (various strains) and non-vlhA (S6 strain) promoters of M. gallisepticum  }
...
```{r SIDD calculation for vlhA promoters}
...
```{r Saving the complete SIDD data}
...
write.csv(vlhA_sidds, file = '/home/mikhail/Documents/Papers_presentations/Frontiers_in_genetics_Mycoplasma/mycoplasma_script_Frontiers/vlhA_sidds.csv')
write.csv(non_vlhA_sidds, file = '/home/mikhail/Documents/Papers_presentations/Frontiers_in_genetics_Mycoplasma/mycoplasma_script_Frontiers/non_vlhA_sidds.csv')
```
